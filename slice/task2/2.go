...
копию arr, поэтому изменения len не сохраняются в исходном arr. При этом еще и изначального cap не хватает
из-за чего "!" в целом записывается в другой массив.
